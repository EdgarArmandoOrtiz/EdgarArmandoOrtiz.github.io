...
document.getElementById('pza1Izq').addEventListener('click', AbrirCAja, false);
document.getElementById('pza1Der').addEventListener('click', CerrarCAja, false);
